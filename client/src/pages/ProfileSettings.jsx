...
export default function ProfileSettings() {
    ...
    useEffect(() => {
        const fetchFreshStatus = async () => {
            ...
            try {
                ...
                const res = await fetch(`pet-adoption-capstone.vercel.app/api/users/${user.id}/public`);
                if (res.ok) {
    ...
    const handleSubmitId = async (e) => {
        ...
        try {
            ...
            const res = await fetch('pet-adoption-capstone.vercel.app/api/users/submit-id', {
                method: 'POST',
                headers: { 
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
