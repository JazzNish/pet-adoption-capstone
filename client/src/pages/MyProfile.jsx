...
export default function MyProfile() {
    ...
    useEffect(() => {
        const fetchMyData = async () => {
            ...
            try {
                const userRes = await fetch(`pet-adoption-capstone.vercel.app/api/users/${localUser.id}/public`);
                if (userRes.ok) {
                ...
                const petsRes = await fetch(`pet-adoption-capstone.vercel.app/api/pets/my-pets/${localUser.id}`);
                if (petsRes.ok) {
    ...
    const handleSaveAbout = async () => {
        setIsSaving(true);
        try {
            const res = await fetch('pet-adoption-capstone.vercel.app/api/users/profile', {
                method: 'PUT',
                headers: { 
